# Programa para verificar que binom.sim funciona
# generando una muestra grande usando el programa binom.sim,
# estimando pX y comparando con el valor conocido de la pmf.
